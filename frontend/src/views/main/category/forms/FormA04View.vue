        ...
        <div >
            ...
            <form class="d-flex flex-column">
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-control">
                        <input type="email" class="form-control" v-model="docData.email" :disabled="role == 'user'"/>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-control">
                        <input type="tel" class="form-control" v-model="docData.noHp" :disabled="role == 'user'"/>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-control">
                        <input type="number" class="form-control" v-model="docData.noNPWP" :disabled="role == 'user'"/>
